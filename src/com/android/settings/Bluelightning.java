/*
 * Copyright (C) 2012 Bluelightning Project
 *
...
public class Bluelightning extends SettingsPreferenceFragment implements
        Preference.OnPreferenceChangeListener {
    private static final String TAG = "Bluelightning";
    ...
    private static final String BL_HARDWARE_KEYS = "bl_hardware_keys";
    private static final String BL_GENERAL_UI = "bl_general_ui";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.bluelightning_settings);
        ...
        if (!hasHardwareButtons) {
                  getPreferenceScreen().removePreference(findPreference(BL_HARDWARE_KEYS));
                  PreferenceCategory generalCategory = (PreferenceCategory) findPreference(BL_GENERAL_UI);
